 ...
 */
class FizzBuzzWhile { // This defines the code to be run? Or is it that if I press run it will know main
    ...
    public static void main(String[] args) { // Defines global static function that takes in no input but spits out a list of strings
        int i = 1;
        while (i < 100) { // For loop that increments by 1 for i in 1 to 99, 99 numbers
